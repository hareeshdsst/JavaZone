...
public class OrdersDaoStubImpl implements OrderDao{
    ...
    public OrdersDaoStubImpl() {
        ...
        onlyOrder.setCstPerSqrFt(new BigDecimal("1.75"));
        onlyOrder.setLaborcstPerSqrFt(new BigDecimal("2.10"));
        onlyOrder.setMaterialCost(onlyOrder.getCstPerSqrFt()
                .multiply(onlyOrder.getArea()).setScale(2, RoundingMode.HALF_UP));
        onlyOrder.setLaborCost(onlyOrder.getLaborcstPerSqrFt().multiply(onlyOrder.getArea())
