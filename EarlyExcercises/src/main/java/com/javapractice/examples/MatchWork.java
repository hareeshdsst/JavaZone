...
public class MatchWork {
	public static void main(String[] args) {
		System.out.println(" The word Cart should come before Horse alphabetically : " + comesBefore("a", "c"));
		System.out.println(" Half of 42 = " + halfOf(10.5));
		System.out.println(" (short) Pi = " + pi());
		System.out.println(" The first letter of the word Llama is: " + firstLetter("Hareesh"));
		System.out.println(" 1337 x 1337 = " + times1337(4));
	}
